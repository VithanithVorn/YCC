...
int main()
{
    ...
    "Rice with fries chicken", "Rice with BBQ chicken", "Fries rice with fries pork", "Fries rice with BBQ pork", 
    "Rice with fries pork", "Rice with BBQ pork", "Pork kathiew", "Cow meat ball kathiew"};
    string drinknames[] = {"Ice lemon green tea", "Ice lemon red tea", "Ice latte", "Ice americano", "Ice tea"};
    ...
    while (true) 
    {
        ...
        if (cin.fail()) // Check if the input is invalid
        {
            ...
            cout << "\nInvalid input. Please try again.\n"; // Fix spacing for better readability
            system("pause");
